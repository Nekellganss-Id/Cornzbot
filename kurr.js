...
const ownerNumber = "6289695073357@s.whatsapp.net"
const dtod = "629695073357@s.whatsapp.net"
const otod = "629695073357@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© CREATED BY NEKELL404_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6289695073357-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "*_© CREATED BY NEKELL404_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T TOUCH MY IDOL!",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/629695073357`}}})
		}
...
if(budy.includes('NEKELL404')){
cpref = `Hayo Ngomongin NEKELL 404 Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('NEKELL')){
cpref = `Hayo Ngomongin NEKELL404 Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© CREATED BY NEKELL404_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'fbm', buttonText: {displayText: 'Facebook'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/nekellgatau')
}
if(isButton == 'fbm'){
reply('http://facebook.com/nekellganss')
}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© CREATED BY NEKELL404_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
`
sendButLocation(from, `${menu}`, "*_© CREATED BY NEKELL404_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'catalog': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' CATALOG MENU '
       ownerJid = "629695073357@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
*ANDA INGIN MEMPUNYAI LOGO/EDITAN KEREN, TAPI ANDA TIDAK BISA NGEDIT NYA?*
*SANSSZZZZ DISINI OWNER SAYA MENYEDIAKAN BERBAGAI MACAM JENIS EDITAN!*
*READY JASA PEMBUATAN LOGO/EDITAN KEREN LAIN NYA!*
*_LANGSUNG AJA CEK LIST NYA!_*

*📍 PEMBUATAN LOGO UNTUK JB*
*📍 PEMBUATAN LOGO UNTUK TEAM (HEKER,ESCROT,DLL)*
*📍 PEMBUATAN LOGO UNTUK BUCIN/SADBOY/SADGIRL*
*📍 PEMBUATAN LOGO UNTUK WM EDITAN*


*READY JUGA JASA EDITAN VIDEO!*

*📍 VIDEO JEDAGJEDUG (LAGU+FOTO BISA REQUEST!)*
*📍 VIDEO AMV (LAGU+FOTO BISA REQUEST!)*
*📍 VIDEO QUOTES (KATA KATA+MENTAHAN BISA REQUEST!)*
*📍 VIDEO CINEMATIC HD (LAGU+MENTAHAN BISA REQUEST!)*
*📍 VIDEO GMV (LAGU+KATA KATA BISA REQUEST!)*

*_📌 JIKA LIST DI ATAS TIDAK ADA YANG ANDA CARI, SILAHKAN HUBUNGI OWNER AGAR DI BICARAKAN!*
_JIKA OWNER TIDAK RESPON,MAKA CHAT KE NOMER BOT SAJA!_


*INFORMATION:*
- KEUNTUNGAN : - BISA PAMER KE STORY WA
               - BISA PANSOS KE TIKTOD/IG
               - EDITAN MEMUASKAN DAN TERJAMIN

- KEKURANGAN : - GA ADA LAH ANJG YAKALI SEORANG NEKELL GANTENG KURANG MEMUASKAN:V


*RULES:*
- *DILARANG KERAS UNTUK SPAM TELFON/VC/PESAN. JIKA ANDA MELANGGAR MAKA AKAN OTOMATIS TERBLOK OLEH BOT!*
- *JIKA BELUM LEWAT JANGKA WAKTU, MOHON UNTUK TIDAK SPAM! KARNA PROSES EDITAN NYA LAMA (TERGANTUNG BAHAN!)*
- UDAHLAH SEGITU AE KAN UDAH PADA GEDE JADI TAU ATURAN YA ANJG

*_📌 NOTE : JIKA LIST DI ATAS TIDAJ SESUAI DENGAN YG ANDA CARI, LANGSUNG CHAT OWNER SAJA BARANGKALI BISA DI BANTU_*
*📌 UNTUK HARGA NYA BISA KALIAN TANYAKAN PADA OWNER SAJA, SOALNYA SAYA BOT TIDAK MAU BANYAN TINGKAH!*
...
📥 BERMINAT ? HUBUNGI :
wa.me//6289695073357 ( NEKELL404 )


*MATURSUWUN SEMOGA RAME😄*`
sendButLocation(from, `${menu}`, "*_© CREATED BY NEKELL404_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
MY FACEBOOK
[https://facebook.com/nekellganss
   `
menu =`CornBotz`
gbutsan = [
...
Facebookᵒʷⁿᵉʳ:https://facebook.com/nekellgansd`
sendButLocation(from, `${menu}`, "*_© CREATED BY NEKELL404_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*_© CREATED BY NEKELL404_*',
    buttons: buttons,
    headerType: 1
}
...
break
		...
		case 'sewabot':
		case 'sourcecode':
		anu =`*SC? BILANG NEKELL GANTENG DULU🗿🤙\nDI YT BANYAK COK TAPI DI ENC SEMUA AOWKWOWK:V*`
 buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `*_© CREATED BY NEKELL404_*`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'✗✗✗ NEKELL404', imageMessage: imageMsg,
...
case 'neko':
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              ...
              break
                ...
                case 'carvedwood':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} NEKELL404`)
                    ini_txt = args.join(" ")
                ...
                case 'freefire':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} NEKE404`)
                    ini_txt = args.join(" ")
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "FACEBOOK : NEKELL GANSS"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
const btnasu = {
    contentText: `${anu}`,
    footerText: '*_© CREATED BY NEKELL404🎃_*',
    buttons: punten,
    headerType: 1
}
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289695073357@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
						...
						"message": `${NamaBot}`,
						"orderTitle": `${NamaOwner}`,
						"sellerJid": "6289695073357@s.whatsapp.net",
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/629695073357"}}})
	}
    }
    }
    }
